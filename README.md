Веб-приложение для генерации и управления паролями с тегами. Использует PostgreSQL и BCrypt для шифрования. Поддерживает CRUD, кэширование и гибкие GET-запросы.
